      ...
      <div class="container">
        <div class="row gy-8 justify-content-between">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-in">
            ...
            <p style="text-align: justify;">Layanan Kesehatan (LK) adalah bidang yang fokus pada penyediaan perawatan medis dan peningkatan kualitas hidup. 
              Prosesnya meliputi perawatan pasien, pencegahan penyakit, pengelolaan rumah sakit, dan edukasi kesehatan.</p>
          </div>
        </div>
      </div>
      </div>
